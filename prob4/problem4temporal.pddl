(define (problem healthcare_problem)
    ...
    (:init
        ...
        (=(speed delivery_robot1) 20)
        (=(speed delivery_robot2) 20)
        (=(speed accompany_robot1) 11); average walking speed is 1,3 m/s since we are in a hospital with older people we made it slower 
