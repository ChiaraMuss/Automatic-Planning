(define (problem healthcare_problem)
  ...
  (:goal
    (and
      (= 3 (med_unit_inventory_of medical_unit1 aspirin))
      (= 2 (med_unit_inventory_of medical_unit1 scalpel))
      (= 0 (med_unit_inventory_of medical_unit1 tongue_depressor))
      (= 1 (med_unit_inventory_of medical_unit2 aspirin))
      (= 0 (med_unit_inventory_of medical_unit2 scalpel))
      (= 3 (med_unit_inventory_of medical_unit2 tongue_depressor))
      (patient_at rocco medical_unit1)
      (patient_at ciro medical_unit2)
    )
  )
)
