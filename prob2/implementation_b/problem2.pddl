(define (problem healthcare_problem)
  ...
  (:init
    ...
    (connected central_warehouse medical_unit1)
  ...
  (:goal
    (and
      ;(carrier_at carrier1 medical_unit1)
      ;(contains box1 aspirin)
      ;(carrier_load carrier1 box1)
      (= 2 (med_unit_inventory_of medical_unit1 aspirin))
